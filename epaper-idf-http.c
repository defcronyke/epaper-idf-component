...
void epaper_idf_http_get(struct epaper_idf_http_task_action_value_t action_value)
{
  ...
  // ESP_LOGI(HTTP_TAG, "Loading the server cert. and key...");

  // /** TODO: This demonstration program uses embedded test certificates.
  //  * Instead, you may want to use mbedtls_x509_crt_parse_file() to read the
  //  * server and CA certificates, as well as mbedtls_pk_parse_keyfile().
  //  */
  // ESP_LOGI(HTTP_TAG, "SSL server context set own certification......");
  // ESP_LOGI(HTTP_TAG, "Parsing test srv_crt......");
  // ret = mbedtls_x509_crt_parse(&srvcert, (const unsigned char *)cacert_pem_start,
  //                              cacert_pem_bytes);
  // if (ret != 0)
  // {
  //   ESP_LOGI(HTTP_TAG, " failed\n  !  mbedtls_x509_crt_parse returned %d\n\n", ret);
  //   goto exit;
  // }
  // ESP_LOGI(HTTP_TAG, "OK");

  // ESP_LOGI(HTTP_TAG, "SSL server context set private key......");
